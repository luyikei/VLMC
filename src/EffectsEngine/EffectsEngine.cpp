...
EffectsEngine::makePatch( void )
{
    ...
    else
    {
        ...
        {
            for ( i = 1 ; i <= 64; ++i )
                if ( m_patch->connectParentToChild( i, 1, i ) == false )
